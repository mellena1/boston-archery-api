...
require (
	github.com/abhirockzz/dynamodb-local-testcontainers-go v0.0.0-20240209162301-43db52602e5c
...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/expression v1.7.28
